      ...
      >
        ...
        <View style={styles.sectionCard}>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <MaterialIcons name="location-on" size={22} color="#6A0DAD" />
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <MaterialIcons name="phone" size={22} color="#6A0DAD" />
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <MaterialIcons name="email" size={22} color="#6A0DAD" />
        ...
        <Text style={[styles.sectionTitle, { marginTop: height * 0.02 }]}>
          Connect With Us
        </Text>
